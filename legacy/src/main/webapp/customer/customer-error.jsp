...
<head>
    ...
    <title>Error - Customer Management</title>
...
<body>
    <div id="header">
        ...
        <p>Customer Management Error</p>
    </div>
    
    <div id="main-content">
        <div class="error-container">
            <h2>⚠️ Customer Management Error</h2>
            ...
            <logic:notPresent name="errorMessage">
                <p>An unexpected error occurred while processing your customer management request.</p>
            </logic:notPresent>
